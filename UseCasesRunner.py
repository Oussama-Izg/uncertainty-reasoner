...
axioms = [
    ...
    Reasoner.CertaintyAssignmentAxiom("ex:domain_knowledge", uncertainty_value=0.0),
...
for folder_name in os.listdir(root_dir):
    ...
    if os.path.isdir(folder_path):
        ...
        for filename in os.listdir(folder_path):
            if filename.endswith(".csv") and "result" not in filename and "usecase_1.csv" in filename:
